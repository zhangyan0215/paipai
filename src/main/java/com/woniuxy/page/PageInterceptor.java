...
public class PageInterceptor implements Interceptor{
	...
	public Object intercept(Invocation invocation) throws Throwable {
		System.out.println("jinrulanjieqi!!!!!!!");
		//首先取得当前环境中是否有RowBounds。
		//获取被拦截被代理的目标对象
		StatementHandler statementHandlder = (StatementHandler)invocation.getTarget();
		//在mybatis中，你的运行中的所有参数都放在 MetaObject中。需要先得到元对象的实例
		MetaObject metaObject =MetaObject.forObject(statementHandlder, new DefaultObjectFactory(), new DefaultObjectWrapperFactory(), new DefaultReflectorFactory());
